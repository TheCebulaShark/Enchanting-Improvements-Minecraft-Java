    ...
    private static void writePower(Path outRoot) throws Exception {
        ...
        List<EnchantCostJsonBuilder.LevelRule> rules = List.of(
                ...
                new EnchantCostJsonBuilder.LevelRule(1, rule(
                        3, 3, 1, 1,
                        List.of(
                                EnchantCostJsonBuilder.matItem("minecraft:flint", 6, 16, 2),
                ...
                new EnchantCostJsonBuilder.LevelRule(2, rule(
                        6, 7, 1, 2,
                        List.of(
                                EnchantCostJsonBuilder.matItem("minecraft:flint", 12, 24, 4),
                                EnchantCostJsonBuilder.matItem("minecraft:copper_ingot", 10, 20, 3),
                                EnchantCostJsonBuilder.matItem("minecraft:iron_ingot", 8, 12, 4),
                                EnchantCostJsonBuilder.matItem("minecraft:gold_ingot", 4, 10, 2),
                ...
                new EnchantCostJsonBuilder.LevelRule(3, rule(
                        ...
                        List.of(
                                ...
                                EnchantCostJsonBuilder.matItem("minecraft:copper_ingot", 24, 48, 3),
                                EnchantCostJsonBuilder.matItem("minecraft:iron_ingot", 18, 32, 5),
                                EnchantCostJsonBuilder.matItem("minecraft:gold_ingot", 12, 24, 4),
                                EnchantCostJsonBuilder.matItem("minecraft:emerald", 8, 20, 3)
                        )
                )),
                // level 4
                ...
                new EnchantCostJsonBuilder.LevelRule(5, rule(
                        12, 30, 5, 5,
                        List.of(
                                EnchantCostJsonBuilder.matItem("minecraft:diamond", 12, 16, 3),
                                EnchantCostJsonBuilder.matItem("minecraft:emerald", 48, 64),
                                EnchantCostJsonBuilder.matItem("minecraft:nether_star", 1, 1, 2)
                        )
                ))
        );
